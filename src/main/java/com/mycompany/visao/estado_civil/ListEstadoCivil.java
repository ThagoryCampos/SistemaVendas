...
public class ListEstadoCivil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableEstadoCivil.getTableHeader().setReorderingAllowed(false);
        ...
        if (tableEstadoCivil.getColumnModel().getColumnCount() > 0) {
            tableEstadoCivil.getColumnModel().getColumn(0).setResizable(false);
            tableEstadoCivil.getColumnModel().getColumn(1).setResizable(false);
        }
