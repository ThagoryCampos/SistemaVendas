...
public class ListPais extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablePais.getTableHeader().setReorderingAllowed(false);
        ...
        if (tablePais.getColumnModel().getColumnCount() > 0) {
            tablePais.getColumnModel().getColumn(0).setResizable(false);
            tablePais.getColumnModel().getColumn(1).setResizable(false);
        }
