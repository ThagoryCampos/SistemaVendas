...
public class ListPessoa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tablePessoa.getColumnModel().getColumnCount() > 0) {
            tablePessoa.getColumnModel().getColumn(0).setResizable(false);
            tablePessoa.getColumnModel().getColumn(0).setPreferredWidth(20);
            tablePessoa.getColumnModel().getColumn(1).setResizable(false);
            tablePessoa.getColumnModel().getColumn(2).setResizable(false);
            tablePessoa.getColumnModel().getColumn(3).setResizable(false);
            tablePessoa.getColumnModel().getColumn(4).setResizable(false);
            tablePessoa.getColumnModel().getColumn(5).setResizable(false);
            tablePessoa.getColumnModel().getColumn(6).setResizable(false);
            tablePessoa.getColumnModel().getColumn(7).setResizable(false);
            tablePessoa.getColumnModel().getColumn(8).setResizable(false);
            tablePessoa.getColumnModel().getColumn(9).setResizable(false);
            tablePessoa.getColumnModel().getColumn(10).setResizable(false);
        }
    ...
    private void tablePessoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePessoaMouseClicked
        try{
            if (evt.getClickCount() == 2){
                ...
                modEndereco.setNomeRua(String.valueOf(tablePessoa.getValueAt(tablePessoa.getSelectedRow(), 4)));
                modEndereco.setCep(String.valueOf(tablePessoa.getValueAt(tablePessoa.getSelectedRow(), 5)));
                modEndereco.setNumeroResidencia(String.valueOf(tablePessoa.getValueAt(tablePessoa.getSelectedRow(), 6)));
                //
